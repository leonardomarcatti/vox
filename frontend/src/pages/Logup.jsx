...
const Logup = () => {
   ...
   return (
      <div className="d-flex justify-content-center align-items-center min-vh-100">
         ...
         <div className="shadow-lg rounded-3 col-5 p-4 bg-body-tertiary">

            {status && (
               <h3 className="mb-3 bg-success text-white p-2 rounded">
                  Usuário criado com sucesso
               </h3>
            )}

            <h2 className='mb-3 text-center'>Cadastre-se</h2>
            ...
            <Form method="post">
               ...
               <div className="text-center">
                  <button type="submit" className='btn btn-primary mx-2'>
                     Cadastrar <i className="fa-solid fa-user-plus"></i>
                  </button>

                  <button type="reset" className='btn btn-warning mx-2'>
                     Limpar <i className="fa-solid fa-x"></i>
                  </button>

                  <br />

                  <small>
                     Já é cadastrado? Clique <Link to='/'>aqui</Link>
                  </small>
               </div>
            </Form>
